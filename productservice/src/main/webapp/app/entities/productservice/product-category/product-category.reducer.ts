...
import { IProductCategory, defaultValue } from 'app/shared/model/productservice/product-category.model';
...
const apiUrl = 'services/productservice/api/product-categories';
const apiSearchUrl = 'services/productservice/api/_search/product-categories';

// Actions

export const searchEntities = createAsyncThunk('productCategory/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
