...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productserviceApp.productserviceProductCategory.delete.question">
        <Translate
          contentKey="productserviceApp.productserviceProductCategory.delete.question"
          interpolate={{ id: productCategoryEntity.id }}
        >
