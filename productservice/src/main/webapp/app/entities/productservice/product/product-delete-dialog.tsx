...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productserviceApp.productserviceProduct.delete.question">
        <Translate contentKey="productserviceApp.productserviceProduct.delete.question" interpolate={{ id: productEntity.id }}>
