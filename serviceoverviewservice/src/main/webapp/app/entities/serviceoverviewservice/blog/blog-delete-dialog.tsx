...
export const BlogDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="serviceoverviewserviceApp.serviceoverviewserviceBlog.delete.question">
        <Translate contentKey="serviceoverviewserviceApp.serviceoverviewserviceBlog.delete.question" interpolate={{ id: blogEntity.id }}>
