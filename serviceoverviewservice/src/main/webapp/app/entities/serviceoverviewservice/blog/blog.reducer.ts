...
import { IBlog, defaultValue } from 'app/shared/model/serviceoverviewservice/blog.model';
...
const apiUrl = 'services/serviceoverviewservice/api/blogs';
const apiSearchUrl = 'services/serviceoverviewservice/api/_search/blogs';

// Actions

export const searchEntities = createAsyncThunk('blog/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
