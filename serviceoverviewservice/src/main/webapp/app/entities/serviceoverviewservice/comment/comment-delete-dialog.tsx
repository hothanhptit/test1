...
export const CommentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="serviceoverviewserviceApp.serviceoverviewserviceComment.delete.question">
        <Translate
          contentKey="serviceoverviewserviceApp.serviceoverviewserviceComment.delete.question"
          interpolate={{ id: commentEntity.id }}
        >
