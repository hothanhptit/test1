...
import { IComment, defaultValue } from 'app/shared/model/serviceoverviewservice/comment.model';
...
const apiUrl = 'services/serviceoverviewservice/api/comments';
const apiSearchUrl = 'services/serviceoverviewservice/api/_search/comments';

// Actions

export const searchEntities = createAsyncThunk('comment/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
