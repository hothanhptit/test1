...
export const FilesCommentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="serviceoverviewserviceApp.serviceoverviewserviceFilesComment.delete.question">
        <Translate
          contentKey="serviceoverviewserviceApp.serviceoverviewserviceFilesComment.delete.question"
          interpolate={{ id: filesCommentEntity.id }}
        >
