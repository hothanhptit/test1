...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './blog-category.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IBlogCategory, defaultValue } from 'app/shared/model/serviceoverviewservice/blog-category.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOGCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BLOGCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BLOGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOGCATEGORY actions', async () => {
      const expectedActions = [
        {
