...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESBLOG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FILESBLOGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FILESBLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESBLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESBLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESBLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESBLOG actions', async () => {
      const expectedActions = [
        {
