...
export const FilesBlogDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="serviceoverviewserviceApp.serviceoverviewserviceFilesBlog.delete.question">
        <Translate
          contentKey="serviceoverviewserviceApp.serviceoverviewserviceFilesBlog.delete.question"
          interpolate={{ id: filesBlogEntity.id }}
        >
