  ...
  return {
    ...
    plugins: [
      new ModuleFederationPlugin({
        shareScope: 'default',
        remotes: {
          '@projectservice': `projectservice@/services/projectservice/remoteEntry.js`,
          '@serviceoverviewservice': `serviceoverviewservice@/services/serviceoverviewservice/remoteEntry.js`,
          '@learnservice': `learnservice@http://localhost:9002/remoteEntry.js`,
          '@productservice': `productservice@/services/productservice/remoteEntry.js`,
        },
        shared: {
          ...Object.fromEntries(
