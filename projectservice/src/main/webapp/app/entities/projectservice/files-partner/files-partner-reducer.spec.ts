...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESPARTNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILESPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESPARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESPARTNER actions', async () => {
      const expectedActions = [
        {
