...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './quote.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUOTE actions', async () => {
      const expectedActions = [
        {
