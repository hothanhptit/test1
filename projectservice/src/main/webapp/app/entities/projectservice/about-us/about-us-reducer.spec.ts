...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './about-us.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABOUTUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ABOUTUS actions', async () => {
      const expectedActions = [
        {
