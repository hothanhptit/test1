...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESBANNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILESBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESBANNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESBANNER actions', async () => {
      const expectedActions = [
        {
