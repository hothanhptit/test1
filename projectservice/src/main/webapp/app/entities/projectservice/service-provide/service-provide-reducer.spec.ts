...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEPROVIDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICEPROVIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICEPROVIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICEPROVIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEPROVIDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICEPROVIDE actions', async () => {
      const expectedActions = [
        {
