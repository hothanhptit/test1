...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESABOUTUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILESABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESABOUTUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESABOUTUS actions', async () => {
      const expectedActions = [
        {
