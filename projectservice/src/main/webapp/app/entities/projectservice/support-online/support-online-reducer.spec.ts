...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPORTONLINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUPPORTONLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUPPORTONLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUPPORTONLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUPPORTONLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUPPORTONLINE actions', async () => {
      const expectedActions = [
        {
