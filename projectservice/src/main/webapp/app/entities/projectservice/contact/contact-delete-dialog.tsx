...
export const ContactDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectserviceApp.projectserviceContact.delete.question">
        <Translate contentKey="projectserviceApp.projectserviceContact.delete.question" interpolate={{ id: contactEntity.id }}>
