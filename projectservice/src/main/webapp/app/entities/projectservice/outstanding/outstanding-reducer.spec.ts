...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTSTANDING_LIST actions', async () => {
    ...
    it('dispatches FETCH_OUTSTANDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTSTANDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTSTANDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTSTANDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTSTANDING actions', async () => {
      const expectedActions = [
        {
