...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSESCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COURSESCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COURSESCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSESCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSESCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSESCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSESCATEGORY actions', async () => {
      const expectedActions = [
        {
