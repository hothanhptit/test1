...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESLESSON_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FILESLESSONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FILESLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESLESSON actions', async () => {
      const expectedActions = [
        {
