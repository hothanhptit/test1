...
import { IBlog, defaultValue } from 'app/shared/model/learnservice/blog.model';
...
const apiUrl = 'services/learnservice/api/blogs';
const apiSearchUrl = 'services/learnservice/api/_search/blogs';
