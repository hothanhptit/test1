...
export const BlogDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="learnserviceApp.learnserviceBlog.delete.question">
        <Translate contentKey="learnserviceApp.learnserviceBlog.delete.question" interpolate={{ id: blogEntity.id }}>
