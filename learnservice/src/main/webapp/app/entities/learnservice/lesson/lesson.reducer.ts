...
import { ILesson, defaultValue } from 'app/shared/model/learnservice/lesson.model';
...
const apiUrl = 'services/learnservice/api/lessons';
const apiSearchUrl = 'services/learnservice/api/_search/lessons';

// Actions

export const searchEntities = createAsyncThunk('lesson/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
