...
export const CommentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="learnserviceApp.learnserviceComment.delete.question">
        <Translate contentKey="learnserviceApp.learnserviceComment.delete.question" interpolate={{ id: commentEntity.id }}>
