...
import { IComment, defaultValue } from 'app/shared/model/learnservice/comment.model';
...
const apiUrl = 'services/learnservice/api/comments';
const apiSearchUrl = 'services/learnservice/api/_search/comments';
