...
import { getEntities as getComments } from 'app/entities/learnservice/comment/comment.reducer';
...
export const FilesCommentUpdate = () => {
  ...
  const comments = useAppSelector(state => state.learnservice.comment.entities);
  ...
  const updating = useAppSelector(state => state.learnservice.filesComment.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="learnserviceApp.learnserviceFilesComment.home.createOrEditLabel" data-cy="FilesCommentCreateUpdateHeading">
            <Translate contentKey="learnserviceApp.learnserviceFilesComment.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('learnserviceApp.learnserviceFilesComment.name')}
              ...
              />
              <ValidatedField
                label={translate('learnserviceApp.learnserviceFilesComment.type')}
              ...
              <ValidatedField
                label={translate('learnserviceApp.learnserviceFilesComment.link')}
              ...
              <ValidatedField
                ...
                name="comment"
                data-cy="comment"
                label={translate('learnserviceApp.learnserviceFilesComment.comment')}
                type="select"
              >
                <option value="" key="0" />
                {comments
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/learnservice/files-comment" replace color="info">
