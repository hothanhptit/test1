...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './files-comment.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IFilesComment, defaultValue } from 'app/shared/model/learnservice/files-comment.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILESCOMMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FILESCOMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FILESCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILESCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILESCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILESCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILESCOMMENT actions', async () => {
      const expectedActions = [
        {
