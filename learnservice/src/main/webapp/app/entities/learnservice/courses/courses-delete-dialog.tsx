...
export const CoursesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="learnserviceApp.learnserviceCourses.delete.question">
        <Translate contentKey="learnserviceApp.learnserviceCourses.delete.question" interpolate={{ id: coursesEntity.id }}>
